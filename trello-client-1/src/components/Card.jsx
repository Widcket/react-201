...
class Card extends Component {
    ...
    componentDidMount() {
        ...
        // Necesitamos los datos de la lista para la navegación
    ...
    render() {
        if (this.state.card && this.state.list) { // Si se cargaron la card y su lista
            // Sacamos el timestamp desde el Mongo Id
